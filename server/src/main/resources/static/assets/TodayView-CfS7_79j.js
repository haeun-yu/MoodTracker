var ue=Object.defineProperty;var fe=(e,n,t)=>n in e?ue(e,n,{enumerable:!0,configurable:!0,writable:!0,value:t}):e[n]=t;var T=(e,n,t)=>fe(e,typeof n!="symbol"?n+"":n,t);import{d as he,u as ge,r as N,m as _e,a as F,q as me,c as C,e as d,F as pe,z as Ee,s as x,t as L,C as Y,D as B,n as ve,h as y,A as Ce,p as ye,j as Se,i as K,_ as Re}from"./index-Ci9_C7iA.js";import{d as Oe}from"./diary-GkEj_Okq.js";const Ie="/images/stamp.svg",Ae="/icons/loading.svg";typeof WorkerGlobalScope<"u"&&globalThis instanceof WorkerGlobalScope;const we=/[YMDHhms]o|\[([^\]]+)\]|Y{1,4}|M{1,4}|D{1,2}|d{1,4}|H{1,2}|h{1,2}|a{1,2}|A{1,2}|m{1,2}|s{1,2}|Z{1,2}|SSS/g;function Te(e,n,t,o){let s=e<12?"AM":"PM";return o&&(s=s.split("").reduce((a,i)=>a+=`${i}.`,"")),t?s.toLowerCase():s}function O(e){const n=["th","st","nd","rd"],t=e%100;return e+(n[(t-20)%10]||n[t]||n[0])}function Ne(e,n,t={}){var o;const s=e.getFullYear(),a=e.getMonth(),i=e.getDate(),r=e.getHours(),l=e.getMinutes(),g=e.getSeconds(),m=e.getMilliseconds(),u=e.getDay(),c=(o=t.customMeridiem)!=null?o:Te,h={Yo:()=>O(s),YY:()=>String(s).slice(-2),YYYY:()=>s,M:()=>a+1,Mo:()=>O(a+1),MM:()=>`${a+1}`.padStart(2,"0"),MMM:()=>e.toLocaleDateString(t.locales,{month:"short"}),MMMM:()=>e.toLocaleDateString(t.locales,{month:"long"}),D:()=>String(i),Do:()=>O(i),DD:()=>`${i}`.padStart(2,"0"),H:()=>String(r),Ho:()=>O(r),HH:()=>`${r}`.padStart(2,"0"),h:()=>`${r%12||12}`.padStart(1,"0"),ho:()=>O(r%12||12),hh:()=>`${r%12||12}`.padStart(2,"0"),m:()=>String(l),mo:()=>O(l),mm:()=>`${l}`.padStart(2,"0"),s:()=>String(g),so:()=>O(g),ss:()=>`${g}`.padStart(2,"0"),SSS:()=>`${m}`.padStart(3,"0"),d:()=>u,dd:()=>e.toLocaleDateString(t.locales,{weekday:"narrow"}),ddd:()=>e.toLocaleDateString(t.locales,{weekday:"short"}),dddd:()=>e.toLocaleDateString(t.locales,{weekday:"long"}),A:()=>c(r,l),AA:()=>c(r,l,!1,!0),a:()=>c(r,l,!0),aa:()=>c(r,l,!0,!0)};return n.replace(we,(S,f)=>{var p,E;return(E=f??((p=h[S])==null?void 0:p.call(h)))!=null?E:S})}var q;(function(e){e.STRING="STRING",e.NUMBER="NUMBER",e.INTEGER="INTEGER",e.BOOLEAN="BOOLEAN",e.ARRAY="ARRAY",e.OBJECT="OBJECT"})(q||(q={}));/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class _ extends Error{constructor(n){super(`[GoogleGenerativeAI Error]: ${n}`)}}class w extends _{constructor(n,t){super(n),this.response=t}}class re extends _{constructor(n,t,o,s){super(n),this.status=t,this.statusText=o,this.errorDetails=s}}class I extends _{}/**
 * @license
 * Copyright 2024 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ae="SILENT_ERROR";class tt{constructor(n,t,o,s){this.model=t,this.params=o,this.requestOptions=s,this._history=[],this._sendPromise=Promise.resolve(),this._apiKey=n,o!=null&&o.history&&(et(o.history),this._history=o.history)}async getHistory(){return await this._sendPromise,this._history}async sendMessage(n){var t,o,s,a,i,r;await this._sendPromise;const l=M(n),g={safetySettings:(t=this.params)===null||t===void 0?void 0:t.safetySettings,generationConfig:(o=this.params)===null||o===void 0?void 0:o.generationConfig,tools:(s=this.params)===null||s===void 0?void 0:s.tools,toolConfig:(a=this.params)===null||a===void 0?void 0:a.toolConfig,systemInstruction:(i=this.params)===null||i===void 0?void 0:i.systemInstruction,cachedContent:(r=this.params)===null||r===void 0?void 0:r.cachedContent,contents:[...this._history,l]};let m;return this._sendPromise=this._sendPromise.then(()=>le(this._apiKey,this.model,g,this.requestOptions)).then(u=>{var c;if(u.response.candidates&&u.response.candidates.length>0){this._history.push(l);const h=Object.assign({parts:[],role:"model"},(c=u.response.candidates)===null||c===void 0?void 0:c[0].content);this._history.push(h)}else{const h=R(u.response);h&&console.warn(`sendMessage() was unsuccessful. ${h}. Inspect response object for details.`)}m=u}),await this._sendPromise,m}async sendMessageStream(n){var t,o,s,a,i,r;await this._sendPromise;const l=M(n),g={safetySettings:(t=this.params)===null||t===void 0?void 0:t.safetySettings,generationConfig:(o=this.params)===null||o===void 0?void 0:o.generationConfig,tools:(s=this.params)===null||s===void 0?void 0:s.tools,toolConfig:(a=this.params)===null||a===void 0?void 0:a.toolConfig,systemInstruction:(i=this.params)===null||i===void 0?void 0:i.systemInstruction,cachedContent:(r=this.params)===null||r===void 0?void 0:r.cachedContent,contents:[...this._history,l]},m=ce(this._apiKey,this.model,g,this.requestOptions);return this._sendPromise=this._sendPromise.then(()=>m).catch(u=>{throw new Error(ae)}).then(u=>u.response).then(u=>{if(u.candidates&&u.candidates.length>0){this._history.push(l);const c=Object.assign({},u.candidates[0].content);c.role||(c.role="model"),this._history.push(c)}else{const c=R(u);c&&console.warn(`sendMessageStream() was unsuccessful. ${c}. Inspect response object for details.`)}}).catch(u=>{u.message!==ae&&console.error(u)}),m}}/**
 * @license
 * Copyright 2024 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class at{constructor(n){this.apiKey=n}getGenerativeModel(n,t){if(!n.model)throw new _("Must provide a model name. Example: genai.getGenerativeModel({ model: 'my-model-name' })");return new ie(this.apiKey,n,t)}getGenerativeModelFromCachedContent(n,t){if(!n.name)throw new I("Cached content must contain a `name` field.");if(!n.model)throw new I("Cached content must contain a `model` field.");const o={model:n.model,tools:n.tools,toolConfig:n.toolConfig,systemInstruction:n.systemInstruction,cachedContent:n};return new ie(this.apiKey,o,t)}}const it="AIzaSyCXpx3BdoALyxXrn2TTS629kOaOR0POmuI";class rt{constructor(n){T(this,"genAI",null);T(this,"model",null);T(this,"handleResult",()=>{});T(this,"generate",async n=>{try{const s=(await this.model.generateContent(n)).response.text();this.handleResult(s)}catch(t){console.log(t.message)}});this.handleResult=n,this.genAI=new at(it),this.model=this.genAI.getGenerativeModel({model:"gemini-1.0-pro"})}}const $=e=>(ye("data-v-259aaaee"),e=e(),Se(),e),ct={class:"flex items-center justify-between"},lt={key:0,class:"diary-container px-[30px] py-[60px] w-[35%] fade-in"},dt=$(()=>d("h1",{class:"text-4xl-bold mb-[30px] text-[#222222]"},"오늘의 감정",-1)),ut={class:"grid grid-cols-3"},ft=["onClick"],ht=["src"],gt=$(()=>d("article",null,null,-1)),_t={key:1,class:"w-[60%] fade-in relative"},mt={class:"diary-container px-[40px] py-[30px]"},pt={class:"w-full flex items-end justify-between text-[#484848]"},Et={class:"flex flex-col gap-[20px]"},vt={class:"text-lg-bold"},Ct=$(()=>d("p",{class:"text-lg-regular"},[K(" 오늘은 어떤 하루를 보내셨나요? "),d("br"),K(" 하루를 기록해보세요! ")],-1)),yt={class:"bg-white p-[20px] rounded-[20px] shadow-md flex items-center gap-[20px]"},St=["src"],Rt={class:"relative w-full"},Ot=["disable"],It={class:"absolute bottom-[10px] right-[10px] text-[#5B5B5B] text-sm-light"},At={key:0,class:"absolute top-[-80px] right-[-50px]"},wt=$(()=>d("img",{src:Ie,alt:"diary",class:"w-[200px]"},null,-1)),Tt=[wt],Nt={key:0,class:"flex justify-end mt-[20px]"},xt=["disabled"],bt={key:0,src:Ae,class:"w-[30px] animate-spin"},Mt={key:1},Dt={key:2,class:"diary-container px-[40px] py-[30px] w-[35%] fade-in text-[#434343]"},$t={class:"w-full"},Lt={class:"text-lg-regular"},Gt=$(()=>d("div",{class:"w-full text-end"},[d("p",{class:"text-lg-regular"},"From. Mood Tracker")],-1)),kt=he({__name:"TodayView",setup(e){const n=ve(),{addToast:t}=ge(),o=["Happy","Angry","Sad","IDK","Exhausted","Panicked","Blue","Upset","Peaceful"],s=N(null),a=N({date:"",emotion:"",content:"",feedback:""}),i=N(null),r=N(!1),l=N(!1);_e(async()=>{await F.checkLogin()||(t({message:"로그인이 필요합니다."}),n.push("/login")),s.value=await F.getInformation(),i.value=new rt(c),a.value.date=Ne(new Date,"YYYY-MM-DD")}),me(()=>a.value.content,f=>{f.length>1e3&&(a.value.content=f.slice(0,1e3))});const g=()=>{const f=new Date,p=["일요일","월요일","화요일","수요일","목요일","금요일","토요일"],E=f.getFullYear(),v=f.getMonth()+1,H=f.getDate(),U=p[f.getDay()];return`${E}년 ${v}월 ${H}일 ${U}`},m=f=>{a.value.emotion=f},u=()=>{r.value||(r.value=!0,h())},c=f=>{a.value.feedback=f,S()},h=()=>{const f=`사용자가 하루 동안 기록한 감정을 기반으로 따뜻하고 공감어린 피드백을 작성해줘. 감정에 따라 아래와 같은 피드백을 출력해줘. 각 피드백은 사용자의 감정과 일기 내용을 바탕으로 특별하고 맞춤형으로 작성되어야 해.
...
- Happy: "${s.value.name}, 오늘 정말 기쁜 하루를 보낸 것 같아 기뻐요! 당신의 긍정적인 에너지가 ${a.value.content}을 통해 전해졌어요. 오늘 하루도 너무 수고 많았고, 내일도 이 기운 그대로 멋진 하루가 될 거예요!"

- Angry: "${s.value.name}, 오늘 화가 나는 일이 있었군요. ${a.value.content}을 읽으니 당신의 감정을 충분히 이해할 수 있어요. 때로는 화를 내는 것도 필요해요. 내일은 더 나은 날이 될 거예요. 당신을 항상 응원하고 있어요."

- Sad: "${s.value.name}, 오늘 슬픈 일이 있었군요. ${a.value.content}을 통해 당신의 마음이 느껴져요. 슬픔도 우리가 느껴야 할 중요한 감정이에요. 충분히 쉬고, 당신이 소중한 존재라는 걸 잊지 마세요. 내일은 더 나은 날이 될 거예요."

- Exhausted: "${s.value.name}, 오늘 많이 피곤했나 봐요. ${a.value.content}을 읽으니 정말 힘든 하루를 보낸 것 같아요. 충분히 쉬어야 해요. 당신의 건강이 가장 중요해요. 내일은 더 활기찬 하루가 되길 바랄게요."

- Panicked: "${s.value.name}, 오늘 두려움을 느낀 일이 있었군요. ${a.value.content}을 보니 얼마나 힘들었을지 이해가 돼요. 두려움은 우리를 성장하게 하는 감정이에요. 당신이 이겨낼 수 있다는 걸 믿어요. 내일은 더 안정된 하루가 될 거예요."

- IDK: "${s.value.name}, 오늘 무기력한 하루를 보냈군요. ${a.value.content}을 보니 모든 것이 귀찮게 느껴졌겠어요. 누구나 가끔은 이렇게 느낄 때가 있어요. 충분히 쉬고, 자신을 돌봐주세요. 내일은 더 활기찬 하루가 되길 바라요."

- Blue: "${s.value.name}, 오늘 우울한 기분이었군요. ${a.value.content}을 통해 당신의 마음이 느껴져요. 우울함도 우리가 겪는 중요한 감정이에요. 충분히 쉬고, 자신을 잘 돌봐주세요. 내일은 더 나은 날이 되길 바랄게요."

- Upset: "${s.value.name}, 오늘 속상한 일이 있었군요. ${a.value.content}을 보니 얼마나 마음이 아팠을지 이해가 돼요. 속상함을 느끼는 것도 중요해요. 충분히 쉬고, 자신을 잘 돌봐주세요. 내일은 더 나은 날이 될 거예요."

- Peaceful: "${s.value.name}, 오늘 평온한 하루를 보낸 것 같아 기뻐요. ${a.value.content}을 읽으니 당신의 마음이 안정된 것 같아 좋네요. 평온한 하루를 보낸 만큼 내일도 이렇게 평온하길 바랄게요."

출력 형식:

${s.value.name}, 사용자가 선택한 감정에 따라 적절한 피드백을 여기에 삽입하세요.`;i.value.generate(f)},S=async()=>{var E;const f={emotion:a.value.emotion,content:a.value.content,feedback:a.value.feedback,feedbackCode:"SUCCESS"};await Oe.createDiary((E=s.value)==null?void 0:E.name,f)&&(r.value=!1,l.value=!0)};return(f,p)=>{var E;return y(),C("div",ct,[l.value?x("",!0):(y(),C("section",lt,[dt,d("article",ut,[(y(),C(pe,null,Ee(o,(v,H)=>d("button",{key:H,class:Ce(["emotion-box",a.value.emotion===v?"bg-[#D0A7EB]":"bg-white"]),onClick:U=>m(v)},[d("img",{src:`/icons/emotions/${v}.svg`,alt:"emotion",class:"w-[60px]"},null,8,ht)],10,ft)),64))]),gt])),a.value.emotion?(y(),C("section",_t,[d("article",mt,[d("div",pt,[d("div",Et,[d("label",vt,L(g()),1),Ct]),d("span",yt,[d("img",{src:`/icons/emotions/${a.value.emotion}.svg`,alt:"emotion",class:"w-[30px]"},null,8,St),d("p",null,L(a.value.emotion),1)])]),d("div",Rt,[Y(d("textarea",{"onUpdate:modelValue":p[0]||(p[0]=v=>a.value.content=v),class:"h-[calc(45vh)]",disable:l.value},null,8,Ot),[[B,a.value.content]]),d("p",It,L(a.value.content.length)+"/1000 ",1)]),l.value?(y(),C("div",At,Tt)):x("",!0)]),l.value?x("",!0):(y(),C("div",Nt,[d("button",{class:"btn-primary p-[10px]",onClick:u,disabled:r.value},[r.value?(y(),C("img",bt)):(y(),C("p",Mt,"Submit"))],8,xt)]))])):x("",!0),l.value?(y(),C("section",Dt,[d("div",$t,[d("p",Lt,"To. "+L((E=s.value)==null?void 0:E.name),1)]),Y(d("textarea",{"onUpdate:modelValue":p[1]||(p[1]=v=>a.value.feedback=v),class:"h-[calc(50vh)]",disabled:""},null,512),[[B,a.value.feedback]]),Gt])):x("",!0)])}}}),Ft=Re(kt,[["__scopeId","data-v-259aaaee"]]);export{Ft as default};
