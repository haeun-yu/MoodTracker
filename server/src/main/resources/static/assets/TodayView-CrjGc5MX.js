var dt=Object.defineProperty;var ut=(t,n,e)=>n in t?dt(t,n,{enumerable:!0,configurable:!0,writable:!0,value:e}):t[n]=e;var A=(t,n,e)=>ut(t,typeof n!="symbol"?n+"":n,e);import{d as ft,u as ht,r as D,l as gt,n as _t,c as C,b as d,F as pt,s as mt,q as T,t as L,v as P,x as F,m as Et,g as v,y as Ct,p as vt,i as yt,h as Y,_ as Rt}from"./index-DlILk3ox.js";import{a as St}from"./auth-CNAqI4To.js";const Ot="/images/stamp.svg",It="/icons/loading.svg";typeof WorkerGlobalScope<"u"&&globalThis instanceof WorkerGlobalScope;const wt=/[YMDHhms]o|\[([^\]]+)\]|Y{1,4}|M{1,4}|D{1,2}|d{1,4}|H{1,2}|h{1,2}|a{1,2}|A{1,2}|m{1,2}|s{1,2}|Z{1,2}|SSS/g;function At(t,n,e,s){let o=t<12?"AM":"PM";return s&&(o=o.split("").reduce((i,a)=>i+=`${a}.`,"")),e?o.toLowerCase():o}function S(t){const n=["th","st","nd","rd"],e=t%100;return t+(n[(e-20)%10]||n[e]||n[0])}function Tt(t,n,e={}){var s;const o=t.getFullYear(),i=t.getMonth(),a=t.getDate(),r=t.getHours(),l=t.getMinutes(),g=t.getSeconds(),p=t.getMilliseconds(),u=t.getDay(),c=(s=e.customMeridiem)!=null?s:At,h={Yo:()=>S(o),YY:()=>String(o).slice(-2),YYYY:()=>o,M:()=>i+1,Mo:()=>S(i+1),MM:()=>`${i+1}`.padStart(2,"0"),MMM:()=>t.toLocaleDateString(e.locales,{month:"short"}),MMMM:()=>t.toLocaleDateString(e.locales,{month:"long"}),D:()=>String(a),Do:()=>S(a),DD:()=>`${a}`.padStart(2,"0"),H:()=>String(r),Ho:()=>S(r),HH:()=>`${r}`.padStart(2,"0"),h:()=>`${r%12||12}`.padStart(1,"0"),ho:()=>S(r%12||12),hh:()=>`${r%12||12}`.padStart(2,"0"),m:()=>String(l),mo:()=>S(l),mm:()=>`${l}`.padStart(2,"0"),s:()=>String(g),so:()=>S(g),ss:()=>`${g}`.padStart(2,"0"),SSS:()=>`${p}`.padStart(3,"0"),d:()=>u,dd:()=>t.toLocaleDateString(e.locales,{weekday:"narrow"}),ddd:()=>t.toLocaleDateString(e.locales,{weekday:"short"}),dddd:()=>t.toLocaleDateString(e.locales,{weekday:"long"}),A:()=>c(r,l),AA:()=>c(r,l,!1,!0),a:()=>c(r,l,!0),aa:()=>c(r,l,!0,!0)};return n.replace(wt,(y,f)=>{var E,m;return(m=f??((E=h[y])==null?void 0:E.call(h)))!=null?m:y})}var B;(function(t){t.STRING="STRING",t.NUMBER="NUMBER",t.INTEGER="INTEGER",t.BOOLEAN="BOOLEAN",t.ARRAY="ARRAY",t.OBJECT="OBJECT"})(B||(B={}));/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function H(t){return t.text=()=>{if(t.candidates&&t.candidates.length>0){if(t.candidates.length>1&&console.warn(`This response had ${t.candidates.length} candidates. Returning text from the first candidate only. Access response.candidates directly to use the other candidates.`),G(t.candidates[0]))throw new w(`${R(t)}`,t);return Ft(t)}else if(t.promptFeedback)throw new w(`Text not available. ${R(t)}`,t);return""},t.functionCall=()=>{if(t.candidates&&t.candidates.length>0){if(t.candidates.length>1&&console.warn(`This response had ${t.candidates.length} candidates. Returning function calls from the first candidate only. Access response.candidates directly to use the other candidates.`),G(t.candidates[0]))throw new w(`${R(t)}`,t);return console.warn("response.functionCall() is deprecated. Use response.functionCalls() instead."),Z(t)[0]}else if(t.promptFeedback)throw new w(`Function call not available. ${R(t)}`,t)},t.functionCalls=()=>{if(t.candidates&&t.candidates.length>0){if(t.candidates.length>1&&console.warn(`This response had ${t.candidates.length} candidates. Returning function calls from the first candidate only. Access response.candidates directly to use the other candidates.`),G(t.candidates[0]))throw new w(`${R(t)}`,t);return Z(t)}else if(t.promptFeedback)throw new w(`Function call not available. ${R(t)}`,t)},t}function Ft(t){var n,e,s,o;const i=[];if(!((e=(n=t.candidates)===null||n===void 0?void 0:n[0].content)===null||e===void 0)&&e.parts)for(const a of(o=(s=t.candidates)===null||s===void 0?void 0:s[0].content)===null||o===void 0?void 0:o.parts)a.text&&i.push(a.text),a.executableCode&&i.push("\n```python\n"+a.executableCode.code+"\n```\n"),a.codeExecutionResult&&i.push("\n```\n"+a.codeExecutionResult.output+"\n```\n");return i.length>0?i.join(""):""}function Z(t){var n,e,s,o;const i=[];if(!((e=(n=t.candidates)===null||n===void 0?void 0:n[0].content)===null||e===void 0)&&e.parts)for(const a of(o=(s=t.candidates)===null||s===void 0?void 0:s[0].content)===null||o===void 0?void 0:o.parts)a.functionCall&&i.push(a.functionCall);if(i.length>0)return i}const Yt=[$.RECITATION,$.SAFETY];function G(t){return!!t.finishReason&&Yt.includes(t.finishReason)}function R(t){var n,e,s;let o="";if((!t.candidates||t.candidates.length===0)&&t.promptFeedback)o+="Response was blocked",!((n=t.promptFeedback)===null||n===void 0)&&n.blockReason&&(o+=` due to ${t.promptFeedback.blockReason}`),!((e=t.promptFeedback)===null||e===void 0)&&e.blockReasonMessage&&(o+=`: ${t.promptFeedback.blockReasonMessage}`);else if(!((s=t.candidates)===null||s===void 0)&&s[0]){const i=t.candidates[0];G(i)&&(o+=`Candidate was blocked due to ${i.finishReason}`,i.finishMessage&&(o+=`: ${i.finishMessage}`))}return o}function N(t){return this instanceof N?(this.v=t,this):new N(t)}function Bt(t,n,e){if(!Symbol.asyncIterator)throw new TypeError("Symbol.asyncIterator is not defined.");var s=e.apply(t,n||[]),o,i=[];return o={},a("next"),a("throw"),a("return"),o[Symbol.asyncIterator]=function(){return this},o;function a(c){s[c]&&(o[c]=function(h){return new Promise(function(y,f){i.push([c,h,y,f])>1||r(c,h)})})}function r(c,h){try{l(s[c](h))}catch(y){u(i[0][3],y)}}function l(c){c.value instanceof N?Promise.resolve(c.value.v).then(g,p):u(i[0][2],c)}function g(c){r("next",c)}function p(c){r("throw",c)}function u(c,h){c(h),i.shift(),i.length&&r(i[0][0],i[0][1])}}/**
 * @license
 * Copyright 2024 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
